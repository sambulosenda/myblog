const siteMetadata = {
    ...
    headerTitle: 'Sambulo Senda',
    description: 'Thoughts from a wandering mind',
    language: 'en-us',
    siteUrl: 'https://www.sambulosenda.com',
    siteRepo: 'https://github.com/sambulosenda/mysitet',
    image: '/static/img/avatar.png',
    socialBanner: '/static/img/twitter-card.png',
    email: 'hello@sambulosenda.com',
    github: 'https://github.com/sambulosenda',
    twitter: 'https://twitter.com/sambulosenda',
    linkedin: 'https://www.linkedin.com/in/sambulosenda',
    locale: 'en-UK',
    analytics: {
